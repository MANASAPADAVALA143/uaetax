...
export default function CorporateTaxPage() {
  ...
  return (
    <>
      ...
      {tab === 3 && (
        <div className="bg-gradient-to-br from-card to-[#071228] border border-border rounded-2xl p-8 min-h-[200px] flex items-center justify-center">
          <p className="text-muted text-center text-[15px]">AI narrative will appear here</p>
        </div>
      )}
